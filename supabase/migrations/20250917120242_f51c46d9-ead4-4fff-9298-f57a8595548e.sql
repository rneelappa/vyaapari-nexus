...
CREATE TABLE IF NOT EXISTS public.trn_inventory (
  ...
  voucher_guid character varying DEFAULT '',
...
-- Create RLS policy for trn_inventory
...
CREATE INDEX IF NOT EXISTS idx_trn_inventory_voucher_guid ON public.trn_inventory(voucher_guid);
