-- Add performance indexes for Tally tables based on actual column structure

-- Add indexes for trn_accounting (has voucher_guid column)
...
-- Add updated_at trigger for trn_inventory
