...
/**
 * Test Tally GET API Endpoints - Production
...
async function testWithFilters() {
  ...
  try {
    // Test ledgers with search filter
    const response = await makeRequest(
...
async function runGetApiTests() {
  console.log('🚀 Testing Tally GET API Endpoints - Production');
  console.log('================================================');
