...
export type Database = {
  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "bkp_mst_company"
      ...
      bkp_mst_opening_batch_allocation: {
        Row: {
          _godown: string
          _item: string
          company_id: string | null
      ...
      bkp_mst_opening_bill_allocation: {
        Row: {
          _ledger: string
          bill_credit_period: number
      ...
      bkp_mst_stockitem_standard_cost: {
        Row: {
          _item: string
          company_id: string | null
          date: string | null
      ...
      bkp_mst_stockitem_standard_price: {
        Row: {
          _item: string
          company_id: string | null
          date: string | null
        ...
        Relationships: [
          {
            ...
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "bkp_tally_sync_jobs"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      bkp_trn_cost_inventory_category_centre: {
        Row: {
          _costcategory: string
          _costcentre: string
          _item: string
      ...
      bkp_trn_inventory_accounting: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["division_id"]
            isOneToOne: false
            referencedRelation: "bkp_mst_division"
            referencedColumns: ["division_id"]
          },
        ]
      }
      bkp_trn_party_details: {
        Row: {
          company_id: string | null
          created_at: string | null
          division_id: string | null
